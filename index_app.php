...
<option value="v1.1/SimpleTVBlur.OpenGL.xml">SimpleTVBlur.OpenGL</option>
		...
		<div id="tv"><img src="images/tv.png"></div>
...
<!-- 			<div class="cpuInstructions">
	...
	<script type="text/javascript" src="../bower_components/maphilight/jquery.maphilight.min.js"></script>
	<!-- endbuild -->
	...
	<script type="text/javascript" src="js/gui/keyboardRemapper.js"></script>
